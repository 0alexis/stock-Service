package com.emazon.stock_service.adapters.drivinghttp.dto.util;

public final class DrivingConstant {
private DrivingConstant(){
    throw new IllegalStateException("Utility class");
}
    public static  final String FIELD_NAME_NULL_MESSEGE = "Field name can not be null";
